...
class ScanDevicesSreen extends StatefulWidget {
  ScanDevicesSreen({Key key}) : super(key: key);

  @override
  _ScanDevicesSreenState createState() => _ScanDevicesSreenState();
}

class _ScanDevicesSreenState extends State<ScanDevicesSreen> {
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            StreamBuilder<List<ScanResult>>(
              ...
              initialData: [],
              builder: (c,snapshot)=>Column(
                children: snapshot.data.map((r)=> ScanResultTile(scanResult: r,)).toList(),
              )
            ),
          ],),
        ),
